            ...
            throws ServletException, IOException
  {
      ...
      if(name==null || !type.equals("manager")){
          ...
          if(dvd_id == null){
              ...
              ResultSet rs = da.getResultSet("select r.review,us.name,us.user_name,r.date from review r , users us where us.user_name=r.user_name and dvd_id="+dvd_id);
              ...
              out.println(docType +
                    ...
                    "<br><br><table align='center' border=1><tr><th>Review</th><th>Customer Name</th><th>Username</th><th>Request Date</th></tr>");
                        try{
                            while(rs.next()){
                            out.println(makeTable(rs.getString("review"),rs.getString("name"),rs.getString("user_name"),rs.getDate("date").toString()));
                            }
